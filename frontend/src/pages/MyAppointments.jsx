...
// import { toast } from 'react-toastify';
// import { useNavigate } from 'react-router-dom';
// import { FaArrowRight } from 'react-icons/fa'; // for arrow between patient and doctor
...
//   const cancelAppointment = async (appointmentId) => {
//     try {
//       // Optimistically remove the canceled appointment from the UI
//       setAppointments((prevAppointments) =>
//         prevAppointments.filter((item) => item._id !== appointmentId)
//       );
...
//         toast.success(data?.message || 'Appointment cancelled successfully');
//       } else {
//         // If the cancel failed, re-fetch the appointments to restore them
//         getUserAppointments();
//         toast.error(data?.message || 'Failed to cancel appointment');
//       }
//     } catch (error) {
//       // If an error occurs, revert the optimistic cancellation
//       getUserAppointments();
//       console.log(error);
//       toast.error(error?.message || 'Try again later');
//     }
...
//             <div
//               key={index}
//               className="bg-white/60 backdrop-blur-lg shadow-lg border border-gray-300 rounded-xl p-6 flex flex-col lg:flex-row items-center gap-6 transition-all duration-300 hover:shadow-2xl"
//             >
//               {/* Patient Image */}
//               <div className="flex flex-col items-center text-center">
//                 <img
...
//               {/* Buttons */}
//               <div className="flex flex-col gap-2 w-full sm:w-auto">
//                 <button className="relative overflow-hidden text-gray-900 py-2 px-4 rounded-full border border-gray-500 group">
//                   <span className="absolute inset-0 bg-green-200 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300"></span>
//                   <span className="relative z-10 group-hover:text-black">Pay Online</span>
//                 </button>
//                 <button onClick={() => cancelAppointment(item?._id)} className="relative overflow-hidden text-gray-900 py-2 px-4 rounded-full border border-gray-500 group">
//                   <span className="absolute inset-0 bg-red-300 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300"></span>
//                   <span className="relative z-10 group-hover:text-black">Cancel Appointment</span>
//                 </button>
//               </div>
//             </div>
