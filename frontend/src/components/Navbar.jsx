                        ...
                        <div className='flex items-center gap-2 cursor-pointer group relative'>
                            ...
                            <div className='absolute  top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                                <div className='min-w-45 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                                    ...
                                    <p onClick={() => setToken(false)} className=' hover:text-black cursor-pointer  transition-all duration-300 hover:bg-stone-200 border rounded-md px-0.5 border-transparent'>Logout</p>
                                </div>
                            </div>
                        </div>
